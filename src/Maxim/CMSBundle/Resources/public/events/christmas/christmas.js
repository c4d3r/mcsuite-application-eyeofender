/**
 * CREDITS http://calendar.perfplanet.com/2012/snow-in-canvas-land/
 */
(function() {
    ...
    Snowflake.prototype.reset = function(maxX) {
        ...
        var chanceOfLargeSnowflake = 0.10;
    ...
    (function() {
        ...
        var windowResized;
        var activeFlakes = [];
        var snowflakesPerPixelPerSecond = 0.03;
        var PIx2 = Math.PI*2;
        var assumedFps = 60;
        var settlePoint;
        var snowflakePool = [];
